            ...
            children: <Widget>[
              ...
              LitButton(
                ...
                callback: () async {
                  ...
                  print("\n---------- 🦀 RUST Backend ----------\n");
                  var data = await bls.combineSignatureShares(shares: signatureShares);
              ...
              LitButton(
                ...
                callback: () async {
                  ...
                  var decryptedBase64Data = await bls.verifyAndDecryptWithSignatureShares(
                    publicKey: publicKey,
                    identity: encodedIdentity,
              ...
              LitButton(
                ...
                callback: () async {
                    ...
                    print("\n---------- 🦀 RUST Backend ----------\n");
                    try{
                      await bls.verifySignature(publicKey: publicKey, message: message, signature: signature);
              ...
              LitButton(
                ...
                callback: () async {
                  ...
                  print("\n---------- 🦀 RUST Backend ----------\n");
                  var data = await bls.decryptWithSignatureShares(ciphertext: ciphertext, shares: signatureShares);
              ...
              Text("ECDSA-SDK", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              Container(margin: const EdgeInsets.only(top: 24)),
              LitButton(
                ...
                callback: () async {
                  ...
                  List<Map<String, dynamic>> shares = [
                    {
                      ...
                      "signature_share": 'FEFC58B0E9399B0D1DDAA3AAC084757B0A49D0980C42A5B340C70CB9C36579B0',
                      "share_index": 0,
                      "big_r": '0331654A77AD671F40E5B59AF11F4D78355869973C089AA2846966A024D804AEFC',
                      "public_key": '0473DB2CF6ECEB4E308EFC0B35597C1135B95F5E167445190D2D43CE9E5B6E7C88849422AE5895F0B4C436B3789E292E3C18B30648E9442868B21E088248F28E77',
                      "data_signed": '7D87C5EA75F7378BB701E404C50639161AF3EFF66293E9F375B5F17EB50476F4',
                      "sig_name": 'sig'
                    },
                    {
                      "sig_type": 'ECDSA_CAIT_SITH',
                      "signature_share": '41343580C056A85CD856AF4FB3735AF5A4FB7DF4EEF34286B3F80D305B78F5E4',
                      "share_index": 0,
                      "big_r": '0331654A77AD671F40E5B59AF11F4D78355869973C089AA2846966A024D804AEFC',
                      "public_key": '0473DB2CF6ECEB4E308EFC0B35597C1135B95F5E167445190D2D43CE9E5B6E7C88849422AE5895F0B4C436B3789E292E3C18B30648E9442868B21E088248F28E77',
                      "data_signed": '7D87C5EA75F7378BB701E404C50639161AF3EFF66293E9F375B5F17EB50476F4',
                 ...
                 List<String> sharesString = shares.map((e) => jsonEncode(e)).toList();
        
                  try{
                    var data = await ecdsa.combineSignature(inShares: sharesString, keyType: 2);
              ...
              LitButton(
                ...
                callback: () async {
                  ...
                  const id =  "d856c933322bb32c0f055522c68fc8ffd7bed30c41fffd4e2c4562c28894a7c0";
                  const publicKeys = [
                  ...
                  try{
                    var data = await ecdsa.computePublicKey(id: id, publicKeys: publicKeys);
